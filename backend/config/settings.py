...
CACHES = {
    'default': {
        ...
        'LOCATION': config('REDIS_URL', default='redis://redis_secure_password_2024@redis:6379/1'),
        'OPTIONS': {
...
CELERY_BROKER_URL = config('CELERY_BROKER_URL', default='redis://redis_secure_password_2024@redis:6379/0')
CELERY_RESULT_BACKEND = config('CELERY_RESULT_BACKEND', default='redis://redis_secure_password_2024@redis:6379/0')

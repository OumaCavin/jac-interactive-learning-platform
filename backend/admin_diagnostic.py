...
def check_admin_setup():
    ...
    if not custom_admin_site._registry.get(User):
        print(f"\n🔧 Fix needed!")
        print(f"   The User model needs to be registered with the custom admin site.")
        print(f"   This should happen automatically in users/admin.py")
        print(f"   Check the admin.py file for @admin.register(User, site=custom_admin_site)")
